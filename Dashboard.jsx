    ...
    <div>
      ...
      <div className="bgg">
        ...
        <div className="glasses">
          ...
          <Link to="/antirad" className="card">
            <img src="Antirad.jpg" alt="anti rad" />
            <p className="label">anti rad</p>
          </Link>
        </div>
        <div className="upl">
          <button onClick={handleUploadClick} type="button" className="but">
            Upload image
          </button>
          <br />
          <button onClick={handleUploadClickk}  type="button" className="butt">
            Camera
          </button>
        </div>
      </div>
